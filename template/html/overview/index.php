<ul class="nav nav-tabs"><li id="site" class="step"><a onclick="return Install.goToPage('site')" href="#"><span class="badge">1</span> Configuration</a></li><li id="database" class="step"><a onclick="return Install.goToPage('database')" href="#"><span class="badge">2</span> Database</a></li><li id="summary" class="step active"><a onclick="return Install.goToPage('summary')" href="#"><span class="badge">3</span> Overview</a></li></ul>
