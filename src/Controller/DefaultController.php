...
namespace JoomlaDistro\CmsInstallerApplication\Controller;
...
class DefaultController extends AbstractController implements ContainerAwareInterface
{
     ...
     * @since  1.0
     */
    protected $defaultView = 'configuration';
    ...
    public function execute()
    {
        ...
        $base = '\\JoomlaDistro\\CmsInstallerApplication';
        ...
        {
            $vClass = '\\JoomlaDistro\\CmsInstallerApplication\\View\\Default' . ucfirst($vFormat) . 'View';
            if (!class_exists($vClass)) {
                $vClass = '\\JoomlaDistro\\CmsInstallerApplication\\View\\DefaultHtmlView';
        ...
        $path = JPATH_ROOT.'/template/' . $vName;
