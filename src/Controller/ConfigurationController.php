...
use JoomlaDistro\CmsInstallerApplication\Controller\DefaultController;
...
class ConfigurationController extends DefaultController
{
    public function create()
    {
		...
		$configuration = new \JoomlaDistro\CmsInstallerApplication\Model\ConfigurationModel($this->getApplication(),$this->getInput());
